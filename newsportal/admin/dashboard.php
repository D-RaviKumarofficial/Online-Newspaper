...
<a href="manage-categories.php">
                            <div class="col-lg-4 col-md-4 col-sm-6  ">
                                ...
                                <div class="card-box widget-box-one bg-success ">
                                    <i class="mdi mdi-chart-areaspline text-dark  widget-one-icon"></i>
...
<a href="manage-subcategories.php">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6  ">
                                <div class="card-box   widget-box-one bg-warning ">
   ...
   <div class="row">
      ...
      <a href="trash-posts.php"> <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one bg-danger">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-primary text-info text-overflow" title="User This Month">Trash News</p>
