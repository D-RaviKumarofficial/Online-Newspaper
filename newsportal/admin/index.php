...
<section class="vh-100">
  <p class=" h1  text-center ">Welcome Impact news Admin Login pages </p>
  
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="admin1.jpg" class="img-fluid" alt="samples image">
      </div>
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
            ...
            <button type="button" class="btn btn-floating mx-1">
              <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-twitter-x" viewBox="0 0 16 16">
            ...
            <!-- <div class="container-alt ">
                <div class="row ">
                    <div class="col-sm-12 ">
                        ...
                        <div class="wrapper-page bg-info p-3">

                            <div class="m-t-40 account-pages">
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="bg-">
