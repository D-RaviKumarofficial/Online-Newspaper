...
<html lang="en">
  ...
  <style>
    ...
    <!-- Navigation -->
   <?php include('includes/alterheader.html');?>
...
?>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <h3 class="card-title"><?php echo htmlentities($row['posttitle']);?></h3>
<!--category-->
...
<p>
        ...
        <h5>  <b>Posted by </b> <?php echo htmlentities($row['postedBy']);?> on </b><?php echo htmlentities($row['postingdate']);?> |
          <?php if($row['lastUpdatedBy']!=''):?>
          <b>Last Updated by </b> <?php echo htmlentities($row['lastUpdatedBy']);?> on </b><?php echo htmlentities($row['UpdationDate']);?></p></h5>
        <?php endif;?>
...
<?php } ?>
      ...
      <?php include('includes/alterfooter.html');?>
